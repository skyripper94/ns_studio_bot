...
GRADIENT_COVER_PERCENT = 40      # если хотите отдельно — меняйте; по умолчанию = 35%
GRADIENT_SOLID_FRACTION = 0.45   # какая часть градиента снизу 100% непрозрачная (0.5 = нижняя половина)
GRADIENT_SOLID_RAISE_PX = int(os.getenv("GRADIENT_SOLID_RAISE_PX", "115"))  # ↑ границу "чёрной основы" на N px (скрыть артефакты)
GRADIENT_INTENSITY_CURVE = 2.1   # плавность в верхней половине (больше = резче переход)
